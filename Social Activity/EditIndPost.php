...
$id1=$_POST['hidden'];
$post = "SELECT * FROM individual_posts WHERE id='$id1'";
...
$id=$_POST['id'];
  ...
  $desc=$_POST['desc'];
  $image=$_POST['img'];
  $UpdateQuery = "UPDATE  individual_posts SET title='$title',description='$desc',image_url='$image' WHERE id = '$id' ";
...
<?php
echo "<form method=post action=EditIndPost.php>";
