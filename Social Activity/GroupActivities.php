...
<html lang="en">
      ...
      <head>
       ...
       <link rel="stylesheet" href="styles/GroupActivities.css">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12 border title-div">
                    ...
                    <img src="./assets/images/group1.jpg" width="100%"
                height="500px" alt="">
                <h1 class="text-center mt-5">GROUP ACTIVITIES</h1>
                </div>
            </div>
        </div>
      </section>
...
<?php if($select_group) {
    ...
    echo "<form action=Post.php method=post>";
      echo  "<div class='card  border card-post' style='margin-bottom:20px; margin-left:10px; margin-right:10px; display:block; width:350px;  display: flex; flex: 1 1 auto; border:none;background-color: transparent; flex-direction: row; align-items:left; height: 150px;'>";
      ...
      echo "<input type='hidden' name='category' value=Group_Activities>";
      echo  "<button style='width: 112px; background-color:#016334; color:white'  type='submit' name='GP' class='btn mt-1 ml-0 btn-read' ><b>Read More</b></button>";
      echo "</div>";
      echo "</div>";
      echo "</form>";
    }}
